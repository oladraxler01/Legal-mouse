    ...
    <div className="min-h-screen bg-surface text-on-surface p-6 md:p-12 pb-40 transition-colors duration-300">
      <header className="mb-12 animate-in fade-in duration-700">
        ...
        <p className="font-body text-on-surface-variant text-lg">
          Detailed breakdown for Course ID: <span className="text-on-surface font-mono">{courseId}</span>
        </p>
      </header>

      <div className="bg-surface-container border border-outline-variant/10 rounded-2xl p-12 text-center flex flex-col items-center justify-center animate-in fade-in slide-in-from-bottom-8">
        <div className="w-16 h-16 rounded-full bg-primary/10 flex items-center justify-center text-primary mb-6">
          <BookOpen className="h-8 w-8" />
        </div>
        <h2 className="font-serif text-2xl font-bold mb-3 text-on-surface">Topics Loading...</h2>
