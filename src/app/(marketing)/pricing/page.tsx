  ...
  return (
    <div className="flex-grow flex flex-col items-center pt-24 pb-32 px-6 relative w-full overflow-hidden">
      ...
      <motion.header 
        ...
        variants={stagger}
      >
        <motion.h1 variants={fadeUp} className="font-headline font-bold text-5xl md:text-6xl text-on-surface mb-6 tracking-tight">
          Clarity at every scale.
        </motion.h1>
        <motion.p variants={fadeUp} className="font-body text-xl text-on-surface-variant leading-relaxed max-w-2xl mx-auto">
      ...
      <motion.div 
        className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-8 mb-32 items-stretch"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, margin: "-50px" }}
        variants={stagger}
      >
        ...
        {/* Tier 1: Scholar */}
        <motion.div variants={fadeUp} className="bg-surface-container-lowest rounded-xl p-10 flex flex-col transition-all duration-300 shadow-sm border border-outline-variant/20">
          <div className="mb-8">
        ...
        <motion.div variants={fadeUp} className="bg-surface-container-lowest rounded-xl p-10 flex flex-col relative shadow-md border border-primary/20">
      ...
      <motion.div 
        ...
        variants={stagger}
      >
        <motion.h2 variants={fadeUp} className="font-headline font-bold text-3xl text-center text-on-surface mb-10 tracking-tight">
          Frequently Asked Questions
        </motion.h2>
        <div className="space-y-6">
          <motion.div variants={fadeUp} className="bg-surface-container-lowest rounded-xl p-8 shadow-sm border border-outline-variant/20">
